...
export function Uploadpdf(){
    ...
    function handleDrop(event:SyntheticEvent){
    ...
    return(
        ...
        <form className="mx-5 py-5" >
            ...
            <input type="file" id="upload" name="upload"  className="" accept=".pdf,.txt,.doc,.docx" onChange={handleChange} hidden onDrop={handleDrop}/>
        </form>
        </section>
